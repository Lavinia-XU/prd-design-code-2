  ...
  "pages": [
    {
      ...
      "sections": [
        ...
        },
        {
          ...
          "filterFields": [{"name": "风险等级", "component": "下拉多选", "iduxComponent": "IxSelect", "mode": "多选", "options": "高、中、低", "default": "全部", "description": "按风险等级筛选"}, {"name": "处置状态", "component": "下拉单选", "iduxComponent": "IxSelect", "mode": "单选", "options": "待处置、处理中、已处置", "default": "全部", "description": "按处置状态筛选"}, {"name": "时间范围", "component": "日期范围选择器", "iduxComponent": "IxDatePicker.RangePicker", "mode": "范围", "options": "最近7天、最近30天、自定义", "default": "最近7天", "description": "按发现时间范围筛选"}, {"name": "事件名称", "component": "输入框", "iduxComponent": "IxInput", "mode": "模糊搜索", "options": "-", "default": "空", "description": "支持模糊搜索"}],
